package scene {
	...
	public class Floor4Scene extends Scene {
		...
		private static var SCRIPT:Array = [
			...
			{PERCENT:0.26, CHARACTER:CHARACTER_ROMEO, ID:1, POSITION:[280, 95] },
			{PERCENT:0.26, CHARACTER:CHARACTER_ROMEO, ID:1, POSITION:[460, 95] },
			{PERCENT:0.32, CHARACTER:CHARACTER_ROMEO, ID:1, POSITION:[780, 95] },
			
			{PERCENT:0.32, CHARACTER:CHARACTER_THUG_RED, ID:1, POSITION:[250, 95] },
			{PERCENT:0.34, CHARACTER:CHARACTER_THUG_RED, ID:1, POSITION:[540, 95] },
			
			{PERCENT:0.32, CHARACTER:CHARACTER_THUG_RED, ID:2, POSITION:[300, 95] },
			{PERCENT:0.34, CHARACTER:CHARACTER_THUG_RED, ID:2, POSITION:[590, 95] },
			
			{PERCENT:0.32, CHARACTER:CHARACTER_THUG_RED, ID:3, POSITION:[350, 95] },
			{PERCENT:0.34, CHARACTER:CHARACTER_THUG_RED, ID:3, POSITION:[640, 95] },
			...
			{PERCENT:0.44, CHARACTER:CHARACTER_ROMEO, ID:1, TEXT:"Art thou so bare and full of wretchedness, And fear'st to die?" },
			
			{PERCENT:0.46, CHARACTER:CHARACTER_ROMEO, ID:1, TEXT:"Thou detestable maw, thou womb of death," },
			{PERCENT:0.466, CHARACTER:CHARACTER_ROMEO, ID:1, TEXT:"Thus I enforce thy rotten jaws to open," },
			{PERCENT:0.47, CHARACTER:CHARACTER_ROMEO, ID:1, TEXT:"and cram thee with more food!" },
			{PERCENT:0.6, CHARACTER:CHARACTER_ROMEO, ID:1, POSITION:[790, 700], SPEED:2 },
